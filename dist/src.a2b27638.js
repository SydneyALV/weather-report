...
// // Location API
var findLatitudeAndLongitude = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get('https://weather-report-proxy-server-jk7z.onrender.com/location', {
            params: {
              q: city
            }
          });
  ...
  return function findLatitudeAndLongitude(_x) {
    return _ref.apply(this, arguments);
  };
}();

// OpenWeather API
var findTemp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var cityname, _yield$findLatitudeAn, latitude, longitude, response, current_temp, tempNumber, celsius, fahrenheit;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          cityname = state.cityName;
          _context2.next = 3;
          return findLatitudeAndLongitude(cityname);
        case 3:
          _yield$findLatitudeAn = _context2.sent;
          latitude = _yield$findLatitudeAn.latitude;
          longitude = _yield$findLatitudeAn.longitude;
          _context2.prev = 6;
          _context2.next = 9;
          return _axios.default.get('https://weather-report-proxy-server-jk7z.onrender.com/weather', {
            params: {
              "lat": latitude,
              "lon": longitude
            }
...
var initialTemp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var temp;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          temp = document.getElementById("temp-number");
  ...
  return function initialTemp() {
    return _ref3.apply(this, arguments);
  };
}();
var decreaseTemp = function decreaseTemp() {
  var temp = document.getElementById("temp-number");
  temp.textContent = state.tempNumber -= 1;
  changeColorTemp();
  changeLandscape();
};
var increaseTemp = function increaseTemp() {
  var temp = document.getElementById("temp-number");
  temp.textContent = state.tempNumber += 1;
  changeColorTemp();
  changeLandscape();
};
var changeColorTemp = function changeColorTemp() {
  var temp = document.querySelector("#temp-number");
...
var resetCityToAtlanta = function resetCityToAtlanta() {
  var reset_city = document.getElementById("city-title");
  reset_city.textContent = "Atlanta";
};
var changeLandscape = function changeLandscape() {
...
var changeSky = function changeSky(_ref4) {
  var value = _ref4.target.value;
  var sky = document.getElementById("sky");
  var skyBackground = document.getElementById("sky-gradient");
  if (value == "Sunny") {
...
var changeCityName = function changeCityName() {
  var cityNameBox = document.getElementById("city-title");
  var cityInput = document.getElementById("city-input");
  var cityInputContent = cityInput.value;
  state.cityName = cityInputContent;
  cityNameBox.textContent = cityInputContent;
};
var convertCelsius = function convertCelsius() {
...
var convertFahrenheit = function convertFahrenheit() {
...
var registerEvents = function registerEvents() {
  ...
  var cityTitle = document.querySelector("#city-input");
  cityTitle.addEventListener("input", changeCityName);
  var skySelect = document.getElementById("sky-selector");
  skySelect.addEventListener("change", changeSky);
  var searchCity = document.getElementById("real-temp-button");
...
// document.addEventListener("DOMContentLoaded", registerEvents)
},{"../node_modules/regenerator-runtime/runtime.js":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
